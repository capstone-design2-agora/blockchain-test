...
2. **QBFT**: 최고 처리량 달성 (평균 **57.3 TPS**, RAFT 대비 1.4배)
...
- **부하 조건**: 5가지 TPS 목표 (50, 100, 250, 500 TPS)
- **반복 횟수**: 각 조건당 5회 반복 (총 75회 테스트)
...
|------------|----------|------|------|--------|
| RAFT | 25,000 tx | 25,000 | 0 | **100%** ✅ |
| QBFT | 20,000 tx | 20,000 | 0 | **100%** ✅ |
| IBFT | 25,000 tx | 25,000 | 0 | **100%** ✅ |
